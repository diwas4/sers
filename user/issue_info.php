  ...
  <div class="container">
    ...
    $c=0;
      ...
      if(isset($_SESSION['login_user']))
      {
        ...
        issue,issue_eqp.`return` FROM user inner join issue_eqp ON user.username=issue_eqp.username 
        inner join equipment ON issue_eqp.equipment_id=equipment.equipment_id WHERE issue_eqp.username 
        ='$_SESSION[login_user]' and issue_eqp.approve !='' ORDER BY `issue_eqp`.`return` ASC";
    ...
    echo "</table>";
      ...
      {
        ?>
          <h3 style="text-align: center;">Login to see information of Borrowed Equipments</h3>
        <?php
      }
    ?>
  </div>
